...
Contains powershell scripts to access our capture client. The current version number of our capture client is 1.14 and it can be reached via the URL https://api.bludelta.ai/v1-14.
